...
namespace DAL_GPP
{
    public class Xuat_Kho
    {
        ...
        public DataSet ConnectData(DateTime tu_ngay,DateTime den_ngay,object soid = null)
        {
            ...
            string sql = "sp_kho_LayDuLieu_XuatKho_Xml";
            ...
            DataColumn[] parentColumns = { ds.Tables["g"].Columns["IDHDX"] };
            DataColumn[] childColumns = { ds.Tables["ct"].Columns["IDHDX"] };
        ...
        {
            KetNoiData.ConnectData();
            DataSet ds = KetNoiData.ExecuteToDataSet("sp_kho_Insert_XuatKho_Xml", CommandType.StoredProcedure
                                        , "@soid", SqlDbType.Int, soid
        ...
        {
            KetNoiData.ConnectData();
            DataSet ds = KetNoiData.ExecuteToDataSet("sp_kho_Update_XuatKho_Xml", CommandType.StoredProcedure
                                      , "@soid", SqlDbType.Int, soid
                                      , "@XmlData_g", SqlDbType.NVarChar, xml_g.ToString()
                                      , "@XmlData_ct", SqlDbType.NVarChar, xml_ct.ToString()
                                      );
        ...
        {
            KetNoiData.ConnectData();
            DataSet ds = KetNoiData.ExecuteToDataSet("sp_kho_Xoa_XuatKho_Xml    ", CommandType.StoredProcedure
